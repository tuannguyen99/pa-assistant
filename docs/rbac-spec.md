...
- User
  ...
  - email: string
  - fullName: string
  - roles: string[] // e.g., ["employee", "manager", "hr_admin", "general_director", "board_manager"]
...
- General Director and Board of Manager roles have read access to all reviews and exclusive authority to approve final performance decisions (board_approved state transition).
...
- POST /api/admin/users/:id/roles
  - body: { roles: ["employee","manager","hr_admin","general_director","board_manager"] }
